...
ActiveRecord::Schema.define(version: 20180418115318) do
  ...
  add_index "settings", ["target_type", "target_id", "var"], name: "index_settings_on_target_type_and_target_id_and_var", unique: true, length: {"target_type"=>100, "target_id"=>nil, "var"=>100}, using: :btree
