...
ActiveRecord::Schema[7.1].define(version: 2025_07_08_102008) do
  ...
  create_table "org_domains", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["org_id"], name: "index_org_domains_on_org_id"
  end

  create_table "org_rors", force: :cascade do |t|
    t.bigint "org_id", null: false
    t.text "ror_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["org_id"], name: "index_org_rors_on_org_id"
  end
  ...
  create_table "question_identifiers", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "versionable_id", limit: 36
    t.index ["versionable_id"], name: "index_question_identifiers_on_versionable_id"
  end
  ...
  add_foreign_key "org_domains", "orgs"
  add_foreign_key "org_rors", "orgs"
