...
namespace :rewrite_postgres do
    ...
    task templates: :environment do
        ...
        t.each { |x| 
            ...
            archived = x['archived']==0? false:true
            is_default = x['is_default']==0? false:true
    ...
    task phases_and_translations: :environment do
        ...
        ps.each { |x| 
            modifiable = x['modifiable']==0? false:true
    ...
    task questions_and_translations: :environment do
        ...
        q.each { |x| 
            ...
            modifiable = x['modifiable']==0? false:true
            option_comment_display = x['option_comment_display']==0? false:true
    ...
    task plans: :environment do
        ...
        plans.each { |x| 
            ...
            feedback_requested = x['feedback_requested']==0? false:true
            complete = x['complete']==0? false:true
            ethical_issues = x['ethical_issues']==0? false:true
    ...
    task annotations_answers_options_suggested_answers: :environment do
        ...
        answers_question_options.each { |x| 
        ...
        suggested_answers.each { |x| 
            is_example = x['is_example']==0? false:true
    ...
    task organisations_types_token_permissions: :environment do
        ...
        organisations.each { |x| 
            is_other = x['is_other']==0? false:true
            display_in_registration = x['display_in_registration']==0? false:true
    ...
    task projects_files: :environment do
        ...
        project_groups.each { |x| 
            project_creator = x['project_creator']==0? false:true
            project_editor = x['project_editor']==0? false:true
            project_administrator = x['project_administrator']==0? false:true
    ...
    task settings_sessions_stats_stylesheets: :environment do
        ...
        stats.each { |x| 
            filtered = x['filtered']==0? false:true
    ...
    task trackers_notes_prefs_dmptemplates_migrations: :environment do
        ...
        dmptemplate_translations.each { |x| 
        ...
        dmptemplates_guidance_groups.each { |x| 
