...
console.log(`HERE: ${el.attr('id')} :: ${el.closest('fieldset').length} || ${el.closest('fieldset').find('[type="checkbox"]').length} ^^ ${el.closest('fieldset').find('[type="checkbox"]:checked').length}`);
