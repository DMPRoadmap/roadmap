...
*/
    ...
    $('.new_question_save_button').click(function(e){
        ...
        if ($('#new_question_text_'+ s_id).val() == ''){
            alert(_('Question text is empty, please enter your question.'));
            return false;
        }
    });
