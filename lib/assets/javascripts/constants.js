...
export const MAX_NUMBER_GUIDANCE_SELECTIONS = 6;
...
export const SHIBBOLETH_DISCOVERY_SERVICE_SHOW_LIST = 'See the full list of participating institutions.';

export const NO_TEMPLATE_FOUND_ERROR = 'Unable to find a suitable template for the research organisation and funder you selected.';
export const NEW_PLAN_DISABLED_TOOLTIP = 'Please select a research organisation and funder to continue.';
