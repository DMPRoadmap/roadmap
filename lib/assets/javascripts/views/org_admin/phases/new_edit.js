...
$(() => {
  ...
  Validator.enableValidations({ selector: '.phase_form' });
  ...
  const initQuestion = (context) => {
    ...
    if (isObject(target)) {
      ...
      Validator.enableValidations({ selector: `#${context} .question_form` });
  ...
  const initSection = (selector) => {
    if (isString(selector)) {
      ...
      Validator.enableValidations({ selector: `${selector} .edit_section` });
