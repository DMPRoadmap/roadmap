...
$(() => {
  ...
  Validator.enableValidations({ selector: '#personal_details_registration_form' });
  Validator.enableValidations({ selector: '#password_details_registration_form' });
  Validator.enableValidations({ selector: '#preferences_registration_form' });
