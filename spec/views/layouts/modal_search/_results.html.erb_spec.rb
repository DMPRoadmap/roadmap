...
describe "layouts/modal_search/_selections.html.erb" do
  ...
  it "defaults to :results to an empty array, :selected to false, and has a default :no_results_msg" do
  ...
  context "when :selected is false" do
    ...
    it "does not display pagination when :results is empty and displays the no results message" do
      render partial: "layouts/modal_search/results",
           locals: {
              namespace: nil,
              results: [],
  ...
  context "when :selected is true" do
    it "does not display pagination when :results is not empty and does not display no results message" do
      render partial: "layouts/modal_search/results",
           locals: {
              namespace: nil,
              results: Repository.all.page(1),
    ...
    it "does not display pagination when :results is empty and does not display no results message" do
      render partial: "layouts/modal_search/results",
           locals: {
              namespace: nil,
              results: [],
