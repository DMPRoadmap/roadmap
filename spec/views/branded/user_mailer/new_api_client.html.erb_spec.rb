...
describe 'user_mailer/new_api_client' do
  ...
  it 'renders correctly' do
    ...
    expect(rendered.include?(client.name)).to eql(true)
    expect(rendered.include?(client.description)).to eql(true)
    expect(rendered.include?(client.homepage)).to eql(true)
    expect(rendered.include?(client.contact_name)).to eql(true)
