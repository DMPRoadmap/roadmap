...
module Mocks
  module DataciteMocks
    ...
    ERROR_RESPONSE = Rails.root.join('spec', 'support', 'mocks', 'datacite', 'error.json').read.freeze

    SUCCESS_RESPONSE = Rails.root.join('spec', 'support', 'mocks', 'datacite', 'success.json').read.freeze
