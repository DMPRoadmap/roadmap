...
RSpec.describe "Questions::Date questions" do
  ...
  before do
    ...
    @question = create(:question, :date, section: @section)
    @user              = create(:user)
  ...
  scenario "User answers a date question", :js do
    skip "Not sure how to test date fields?"
