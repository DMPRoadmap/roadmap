...
RSpec.describe "Questions::Multi-select questions" do
  ...
  before do
    ...
    @question = create(:question, :multiselectbox,
                       section: @section, options: 2)
    @user              = create(:user)
  ...
  scenario "User answers a multi select question", :js do
    # Setup
