...
RSpec.describe Api::V1::Deserialization::Dataset do
  before(:each) do
  ...
  describe ':deserialize(json: {})' do
    ...
    context 'initializes' do
      ...
      it 'updates the expected attributes for a ResearchOutput' do
        ...
        expected = Api::V1::ConversionService.yes_no_unknown_to_boolean(@json[:personal_data])
        expect(result.personal_data).to eql(expected)
        expected = Api::V1::ConversionService.yes_no_unknown_to_boolean(@json[:sensitive_data])
