  ...
  describe ".call" do
    context "when an org is passed" do
      it "generates monthly aggregates since org's creation" do
        ...
        april, may, june, july = find_by_dates(dates: %w[2018-04-30 2018-05-31 2018-06-30 2018-07-31], org_id: org.id)
      ...
      it "monthly records are either created or updated" do
        ...
        april_updated = FactoryBot.create(:user, org: org, created_at: DateTime.new(2018, 0o4, 0o5, 0, 0, 0))
