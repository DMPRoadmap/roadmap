class Dmptemplate < ActiveRecord::Base
  ...
  # @return [Array<dmptemplates>] all templates from funder organisations
	def self.funders_templates
		new_org_obejcts = OrganisationType.find_by(name: I18n_constant("organisation_types.funder")).organisations
	  org_templates = Array.new
  ...
  #   or from a funder organisation
    ...
    if current_org.organisation_type.name != I18n_constant("organisation_types.funder") then
