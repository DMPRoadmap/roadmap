  ...
  module V0
    class ProjectsController < Api::V0::BaseController
      ...
      def create
        ...
        if has_auth(I18n_constant("api_endpoint_types.plans"))
          ...
          if !organization.nil?
            ...
            if organization.organisation_type == (OrganisationType.find_by() name: I18n_constant("organisation_types.funder")))
