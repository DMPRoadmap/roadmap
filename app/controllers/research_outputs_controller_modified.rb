...
class ResearchOutputsController < ApplicationController
  ...
  def repository_search
    ...
    authorize @research_output
    # if ActiveRecord::Base.connection.select_rows("SHOW VARIABLES LIKE \"%version%\";")[8][1].downcase.include? "maria" #version_comment
    #   @search_results = Repository.by_type_string(repo_search_params[:type_filter])
