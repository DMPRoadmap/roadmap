...
class TemplatesController < ApplicationController
  ...
  def admin_index
    ...
    organisation_ids = Org.organisation.includes(:templates).where( templates: { published: true, migrated: false }).collect{ |org| org.templates.collect{| ot| ot.dmptemplate_id } }.flatten.uniq
