...
// Get list of breakpoints from --breakpoints variable defined in _breakpoints-js.scss,
// make into array, destructure into "minwidth#" variables, then export them for js module use:
