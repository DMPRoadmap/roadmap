...
function TextArea({ label, name, changeValue, tooltip }) {
  ...
  /**
   * The function takes in an editorState and sets the editorState to the
   * editorState that was passed in.Then, it takes the current content of the
   * editorState and converts it to HTML. Then, it takes the HTML and changes the value
   * of the target to the name of the editor and the value of the
   * description.
