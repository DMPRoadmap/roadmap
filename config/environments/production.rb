...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "dmp_roadmap_production"
...
Rails.application.routes.default_url_options[:host] = "https://#{Rails.configuration.x.dmproadmap.server_host}"
