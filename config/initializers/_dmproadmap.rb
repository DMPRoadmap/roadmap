...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.email = "uc3@ucop.edu"
    # This email is used as the 'from' address for the feedback_complete email to users
    config.x.organisation.do_not_reply_email = "do-not-reply-dmptool-stg@cdlib.org"
    # This email is used in email communications
    config.x.organisation.helpdesk_email = "uc3@ucop.edu"
    ...
    config.x.organisation.contact_us_url = "https://dmptool.org/contact"
    ...
    config.x.application.name = "DMPTool"
    ...
    config.x.google_analytics.tracker_root = "DMPTool"
    ...
    # DOI Minting
    # ----------- #
    config.x.allow_doi_minting = true
