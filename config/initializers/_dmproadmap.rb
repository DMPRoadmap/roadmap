...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.email = 'info-opidor@inist.fr'
    # This email is displayed in public views, a <span> is inserted to prevent bots from using it
    config.x.organisation.safe_email = 'info-opidor<span style="display: none;">REMOVE</span>@inist.fr'
    ...
    config.x.organisation.helpdesk_email = "info-opidor@inist.fr"
    ...
    # DMP OPIDoR Features #
    # --------------------------------------------------- #
    config.x.dmpopidor.enable_research_structure_template = true
